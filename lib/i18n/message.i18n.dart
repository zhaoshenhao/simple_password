...
class PswdMessage {
  ...
  String containUpper(int cnt) =>
      """Must contain $cnt upper case ${_plural(cnt, one: 'letter', many: 'letters')}""";
  String containLower(int cnt) =>
      """Must contain $cnt lower case ${_plural(cnt, one: 'letter', many: 'letters')}""";
  String containDigit(int cnt) =>
      """Must contain $cnt ${_plural(cnt, one: 'digit', many: 'digits')}""";
  String containSpecial(int cnt) =>
      """Must contain $cnt special ${_plural(cnt, one: 'character', many: 'characters')}""";
...
class HomeMessage {
  ...
  String subTitle(String lastUpd, int pswdCnt) =>
      """Last Modified: $lastUpd. Passwords: $pswdCnt""";
}
...
class IapMessage {
  ...
  String get benefits2 =>
      """Allow device authentication for opened password files""";
  ...
  String get buyRefund =>
      """If refund is required, please contact us at https://www.syspole.com""";
  ...
  String get freeLimit =>
      """You can have up to 5 password groups and 5 passwords in each group. Upgrade to Pro version to have unlimited groups and passwords.""";
  ...
  String get verify =>
      """I am 13+ years old, or legal parent/guardian consents to this purchase.""";
  String get thankYouTitle => """Thank You""";
  String get succ =>
      """The purchase is completed. \nThanks you for your supporting.""";
  String get unvail =>
      """Payment function is unavailable now. Please try later.""";
  ...
  String get warn3 =>
      """Save old password files from Free version to shared folder.""";
  String get warn4 => """Open and confirm ALL old password files.""";
  String get warn5 =>
      """After transfering all old password files, you can choose to keep or delete Free version.""";
}
